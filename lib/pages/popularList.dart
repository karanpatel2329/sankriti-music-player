...
class PopularSongList extends StatefulWidget {
  const PopularSongList({Key? key}) : super(key: key);

  @override
  State<PopularSongList> createState() => _PopularSongListState();
}

class _PopularSongListState extends State<PopularSongList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Popular Songs",style: TextStyle(color: primaryColor),),
        centerTitle: true,
        backgroundColor: bgColor,
